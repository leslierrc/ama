...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent('Hola! Me interesa hacer un pedido en AMA Store 🌿')}`}
      target="_blank"
    ...
    >
      {/* Tooltip */}
      <div
        className="rounded-xl px-4 py-2 text-sm font-semibold whitespace-nowrap transition-all duration-300"
        style={{
